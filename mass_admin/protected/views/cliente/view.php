...
$this->menu=array(
	...
	array('label'=>'Actualizar', 'url'=>array('update', 'id'=>$model->id_cliente)),
	array('label'=>'Eliminar Cliente', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id_cliente),'confirm'=>'Are you sure you want to delete this item?')),
